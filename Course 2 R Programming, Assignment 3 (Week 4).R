outcome <- read.csv("C:/Users/nznak/Documents/R/outcome-of-care-measures.csv", colClasses = "character",header = TRUE)
View(outcome)
head(outcome)
names(outcome)
summary(outcome)
outcome[,11]<-as.numeric(outcome[,11])
hist(outcome[,11], xlab = "Death outcomes", main="Hospital.30.Day.Death..Mortality..Rates.from.Heart.Attack")
